...
def main():
    ...
    NCBI_EMAIL = os.getenv('NCBI_EMAIL')  # Required by NCBI
    
    # Initialize components
    pubmed_client = PubMedClient(api_key=NCBI_API_KEY, email=NCBI_EMAIL)

    # # Test search
    # test_pmids = pubmed_client.search(query="hyperlipidemia treatment") 
    # print(test_pmids) 

    # Test advanced search
    test_pmids_adv = pubmed_client.advanced_search(
        PubMedSearchParams(
    ...
    # print(test_pmids_adv)

    # # Test fetch outline
    # test_pap = pubmed_client.fetch_brief(test_pmids_adv)

    # Test fetch details
    test_pap = pubmed_client.fetch_details(test_pmids_adv)  
